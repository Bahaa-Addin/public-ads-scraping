...
This guide is the repo-level bootstrap path for the Public Ads Platform. It standardizes the contributor workflow around the existing Python and npm entrypoints already present in the repository instead of forcing a new monorepo toolchain.
...
- create `platform/.env` from the root [`.env.example`](/Users/monterey/Workspace/Projs/Tasmem/public-ads-scraping/.env.example) if it is missing
...
```bash
cd /Users/monterey/Workspace/Projs/Tasmem/public-ads-scraping/platform
...
```bash
cd /Users/monterey/Workspace/Projs/Tasmem/public-ads-scraping/platform/dashboard/backend
MODE=local \
DATA_DIR=../../data \
...
```bash
cd /Users/monterey/Workspace/Projs/Tasmem/public-ads-scraping/platform/scrapers
npm run server
```
...
```bash
cd /Users/monterey/Workspace/Projs/Tasmem/public-ads-scraping/platform/dashboard/frontend
npm run dev
```
...
The lightweight orchestrator reads [SPEC.md](/Users/monterey/Workspace/Projs/Tasmem/public-ads-scraping/SPEC.md), [TASKS.md](/Users/monterey/Workspace/Projs/Tasmem/public-ads-scraping/TASKS.md), [STATE.json](/Users/monterey/Workspace/Projs/Tasmem/public-ads-scraping/STATE.json), and [ORCHESTRATOR_STATE.json](/Users/monterey/Workspace/Projs/Tasmem/public-ads-scraping/ORCHESTRATOR_STATE.json):
