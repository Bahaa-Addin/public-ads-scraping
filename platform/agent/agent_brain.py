...
The Agent Brain is the central orchestrator for the agentic ads platform.
...
class PipelineStage(Enum):
    """Stages in the agentic ads processing pipeline."""
    SCRAPING = "scraping"
...
class AgentBrain:
    """
    Central orchestration engine for the agentic ads platform.
