...
/**
 * Agentic Ads Scraper - Main Entry Point
 *
 * A Playwright-based scraper for collecting agentic ads from multiple
...
program
  .name('agentic-ads-scraper')
  .description('Scrape agentic ads from public sources')
  .version('1.0.0');
