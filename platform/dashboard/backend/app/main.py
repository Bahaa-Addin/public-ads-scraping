"""
Agentic Ads Dashboard API - Main Application

FastAPI application providing comprehensive APIs for the Agentic Ads
...
app = FastAPI(
    ...
    description="""
## Agentic Ads Dashboard API

Full-stack monitoring and control dashboard for the Agentic Ads Pipeline.
