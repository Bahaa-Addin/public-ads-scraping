...
#
#   name        = "agentic-ads-metadata"
#   description = "Metadata store for agentic ads ML experiments"
#   region      = var.region
# }
...
resource "google_vertex_ai_tensorboard" "creative_ads" {
  ...
  display_name = "agentic-ads-tensorboard"
  description  = "Tensorboard for agentic ads model training"
  region       = var.region
...
resource "google_vertex_ai_dataset" "creative_ads" {
  ...
  display_name        = "agentic-ads-dataset"
