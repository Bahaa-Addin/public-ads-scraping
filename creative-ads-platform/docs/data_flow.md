...
This document describes the data flow through the Creative Ads Platform pipeline.
...
Pub/Sub:
├── creative-ads-jobs                 # Main job topic
├── creative-ads-jobs-sub             # Subscription
└── creative-ads-jobs-dlq             # Dead letter queue
```
