...
locals {
  topic_name     = "creative-ads-jobs"
  dlq_topic_name = "creative-ads-jobs-dlq"
}
...
resource "google_pubsub_topic" "feature_extraction" {
  name    = "creative-ads-feature-extraction"
  project = var.project_id
...
resource "google_pubsub_subscription" "feature_extraction" {
  name    = "creative-ads-feature-extraction-sub"
  project = var.project_id
...
resource "google_pubsub_topic" "prompt_generation" {
  name    = "creative-ads-prompt-generation"
  project = var.project_id
...
resource "google_pubsub_subscription" "prompt_generation" {
  name    = "creative-ads-prompt-generation-sub"
  project = var.project_id
