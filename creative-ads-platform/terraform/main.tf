# Creative Ads Platform - Main Terraform Configuration
#
...
locals {
  service_name = "creative-ads"
  labels = {
    project     = "creative-ads-platform"
...
resource "google_service_account" "platform" {
  ...
  display_name = "Creative Ads Platform Service Account"
  description  = "Service account for the creative ads platform components"
  project      = var.project_id
}
...
resource "google_bigquery_dataset" "analytics" {
  ...
  friendly_name              = "Creative Ads Analytics"
  description                = "Analytics dataset for creative ads platform"
...
resource "google_monitoring_alert_policy" "high_error_rate" {
  ...
  documentation {
    content   = "High error rate detected in Creative Ads Platform services."
