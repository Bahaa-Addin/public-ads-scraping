...
**Name**: Agentic Ads Platform  
**Status**: Active development and workflow hardening  
**Last Updated**: 2026-03-29

Agentic Ads Platform is a local-first, cloud-optional system for collecting public advertising creatives, extracting structured features, classifying industries, and generating reusable reverse prompts. The repository also includes the operator-facing dashboard, validation tooling, deployment infrastructure, and workflow controls needed to evolve the platform safely.
